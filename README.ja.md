...
**Yamaha RTX ルーター + ASUS WiFi AP 対応のリアルタイムネットワーク接続可視化ツール**
...
- オプションで**ASUSルーター**に接続し、WiFiクライアント情報（帯域、信号強度、トラフィック量）を取得
- **7日間の接続履歴**を永続保存
